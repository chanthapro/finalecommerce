...
class HomeController extends Controller
{
    ...
    public function getphoneProduct($id){
    	...
    	return view('client.page.phoneProduct',compact('product','others'));
    }
    ...
    public function getnewsDetails(){
    	return view('client.page.newsDetails');
    }
    public function getcart(){
        $products = Cart::content();
    	return view('client.page.cart',compact('products'));
    }
    ...
    public function postPayment(Request $request){
        try{
            ...
            $mess = "Requested an order! Order information will be sent to your email!";
            Cart::destroy();
