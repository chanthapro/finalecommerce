...
@section('content')
			<div class="main-content">
                <div class="container">
                    <h3>Find <%=total%> results for keywords "<%=keyword%>"</h3>
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 sp_dienthoai" >					
                            ...
                            <li> 
                                <a href="DienThoaiSanPham.jsp?sanpham=<%=sp.getMaSP()%>"> 
                                    ...
                                    <!--<span class="textkm">Promotion value <strong>500.000₫</strong>-->
                                    <!--</span>-->
                                    <p class="info">
                                        <span>Screen: <%=mh.getCongNgheMH()%>, <%=mh.getManHinhRong()%>'</span>
                                        <span>OS: <%=cpu.getHDH()%></span> 
                                        <span>CPU: <%=cpu.getChipSet()%></span>
                                        <span>Camera: <%=camsau.getDoPhanGiai()%></span>
                                        <span>Battery capacity: <%=pin.getDungLuong()%></span>
                                    </p>
